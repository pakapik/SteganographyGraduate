...
{
    public partial class AnalyzerViewUserControl : UserControl, IView
    {
        ...
        public AnalyzerViewUserControl(string name)
        {
            InitializeComponent();
            _activeRBtnName = rBtn_ChiSquare.Name;
            _name = name;
        }
